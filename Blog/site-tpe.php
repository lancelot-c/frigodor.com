...
<table id="tableSite">
	<tr>
    	<td style="min-width:633px;"> 		
			<p class="boutons">
				<?php	$_SESSION['idSite'] = '2';	include("compteur.php");	?>
    		...
    		<h3 class="website">TPE : La 3D au cinéma</h3><hr /><br />
    			
    		<a href="screens_sites/tpe.png">
    			<img src="screens_sites/tpe.png" class="screenshot" alt="Aperçu du site" />
    		</a>
    		<ul style="padding-left:0px;">
    			<li><u class="client"></u> Lycée Saint Erembert de Saint-Germain-en-Laye (78)</li><br />
    			<li><u class="periode"></u> fin 2010</li><br />
    			<li><u class="acces"></u> non disponible</li><br />
    			<li><u class="description"></u> </li>
			</ul>
    	</td>
